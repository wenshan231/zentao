...
<div id='featurebar'>
  ...
  <div class='f-right'>
    ...
    /**
     * coship start
     * 2013-09-06 add/update by fujia
     */
    echo html::a($this->createLink('testtask', 'runreport', "productID=$task->product&taskID=$task->id"), $lang->testcase->runReport);
    /* coship end */
...
<table class='cont-lt1'>
  <tr valign='top'>
    <td class='side <?php echo $treeClass;?>'>
      <!-- coship start 2013-11-08 update by fujia -->
      <div class='box-title' style="width:200px;"><?php echo $productName;?></div>
      <!-- coship end -->
