...
<!-- coship start 2013-10-28 add by fujia -->
<style>
.runReport {
background: url("theme/default/images/main/zt-icons.png") no-repeat scroll -40px -82px rgba(0, 0, 0, 0);
...
<table class='table-1 colored tablesorter fixed'>
  ...
  <tr class='colhead'>
    ...
    <!-- coship start 2013-10-28 update by fujia -->
  ...
  <tr class='a-center'>
    ...
    <!-- coship start 2013-10-28 update by fujia -->
    <td class="a-right">
    <?php if($task->status != 'done') echo html::a($this->createLink('testtask', 'runreport', "productID=$task->product&taskID=$task->id"), '&nbsp;', '', 'class=runReport');?>
    <!-- coship end -->
    <!-- ////<td class='a-center'> -->
      <?php
