    ...
    <td class='side'>
      <fieldset>
        ...
        <table class='table-1 a-left' cellpadding='0' cellspacing='0'>
          ...
          <!-- coship start 2013-09-06 add by fujia -->
          <tr>
            <td class='rowhead'><?php echo $lang->testcase->caseCode;?></td>
            <td><?php echo html::input('caseCode', $case->caseCode, 'class=text-1');?></td>
          </tr>
            <tr>
            <td class='rowhead'><?php echo $lang->testcase->testItem;?></td>
            <td><?php echo html::input('testItem', $case->testItem, 'class=text-1');?></td>
          </tr>
          <!-- coship end -->
          <tr>
