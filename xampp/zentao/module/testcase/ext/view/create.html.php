...
<form method='post' enctype='multipart/form-data' target='hiddenwin' id='dataform'>
  <table class='table-1'> 
    ...
    <tr>
      <th class='rowhead'><?php echo $lang->testcase->caseCode;?></th>
      <td><?php echo html::input('caseCode', $caseCode, "class='text-3'");?></td>
    </tr>  
    <tr>
      <th class='rowhead'><?php echo $lang->testcase->testItem;?></th>
      <td><?php echo html::input('testItem', $testItem, "class='text-3'");?></td>
    </tr>
    <!-- coship end -->
    <tr>
