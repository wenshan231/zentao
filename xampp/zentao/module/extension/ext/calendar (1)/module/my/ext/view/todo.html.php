 ...
 * @package     dashboard
 * @version     $Id: todo.html.php 2378 2011-11-30 02:46:02Z shiyangyangwork@yahoo.cn $
...
<form method='post' target='hiddenwin' action='<?php echo $this->createLink('todo', 'import2Today');?>' id='todoform'>
  <div id='featurebar'>
    ...
    <div class='f-right'>
    <?php 
    	echo html::a($this->createLink('my', 'todocalendar', ""), $lang->my->todocalendar);
        common::printLink('todo', 'export', "account=$account&orderBy=id_desc", $lang->export, '', '');
  ...
  <table class='table-1 tablesorter'>
    ...
    <tr class='colhead'>
      ...
      <th class='w-type' style="display:none;"><?php echo $lang->todo->type;?></th>
    ...
    <tr class='a-center'>
      ...
      <td style="display:none;"><?php echo $lang->todo->typeList->{$todo->type};?></td>
