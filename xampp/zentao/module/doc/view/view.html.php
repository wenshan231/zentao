...
<div id='titlebar'>
  ...
  <div id='main' <?php if($doc->deleted) echo "class='deleted'";?>><?php echo $doc->title . $lang->colon . $lang->doc->view;?></div>
  <!-- coship end -->
...
<table class='cont-rt5'>
  <tr valign='top'>
    <td>
      ...
      <?php endif;?>
      <!-- coship start 2013-08-06 add by fujia -->
      <fieldset>
        <legend>UBB链接</legend>
        <div>
          <input type="text" style="width:600px"  value="<?php echo "[url='doc-view-{$doc->id}']{$doc->title}[/url]"; ?>" />
          <br>访问本文档的链接代码，请完整复制到“备注”中任意位置。
        </div>
      </fieldset>
      <!-- coship end -->
