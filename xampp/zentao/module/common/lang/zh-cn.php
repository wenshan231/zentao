 ...
 * @package     ZenTaoPMS
 * @version     $Id: zh-cn.php 4751 2013-05-05 00:29:24Z chencongzhi520@gmail.com $
...
/**
 * coship start
 * 2013-10-10 add by fujia
 */
$lang->menu->notice   = '公告|notice|index';
 /* coship end */
...
$lang->notice->menu = new stdclass();

/**
 * coship start
 * 2013-12-02 add by fujia
 */
$lang->notice->menu->shining = array('link' => '我要上头条|notice|shining');
/* coship end */
$lang->notice->menu->create  = array('link' => '<span class="icon-add">&nbsp;</span>添加公告|notice|create|moduleID=%s', 'float' => 'right');
$lang->common->shining       = '我要上头条';
/* coship end */
...
/**
 * coship start
 * 2013-12-17 update by fujia
 */
$lang->bug->menu->bug      = array('link' => 'Bug|bug|browse|productID=%s', 'alias' => 'view,create,edit,resolve,close,activate,report,batchedit,confirmbug,assignto,importpreview', 'subModule' => 'tree');
/* coship end */
...
/**
 * coship start
 * 2013-10-28 update by fujia
 */
$lang->testcase->menu->testcase = array('link' => '用例|testcase|browse|productID=%s', 'alias' => 'view,create,batchcreate,edit,batchedit,importpreview', 'subModule' => 'tree');
$lang->testcase->menu->testtask = array('link' => '测试任务|testtask|browse|productID=%s', 'alias' => 'view,create,edit,linkcase,cases,start,close,batchrun,runreport');
/* coship end */
...
/**
 * coship start
 * 2013-09-23 add by fujia
 */
$lang->report->menu->week    = array('link' => '周统计|report|weeklyreport');
$lang->report->menu->month   = array('link' => '月统计|report|monthlyreport', 'alias' => 'bugmonthlyreport');
/* coship end */
...
/**
 * coship start
 * 2013-08-27 delete by fujia
 * 服务器端不能上网，无法从禅道获取应用信息，去掉链接
 */
 ...
 */
$lang->agileTraining  = "<a href='http://10.10.5.166:8080/hudson-2.2.0/' target='_blank' class='red'>windows编译</a> ";
$lang->donate         = "<a href='http://10.10.5.161:8080/hudson-2.2.0/' target='_blank' class='red'>linux编译</a> ";
/* coship end */
 ...
 */
$lang->address         = "<a href='http://10.10.5.37:88/zentao/doc-view-22.html' target='_blank'>取包地址</a> ";
/* coship end */
