 ...
 * @package     user
 * @version     $Id: model.php 4694 2013-05-02 01:40:54Z chencongzhi520@gmail.com $
...
class userModel extends model
{
    ...
    /**
     * coship start
     * 2014-02-26 add by shukaiming
     * 增加一个新的方法，通过用户名$account获得用户所属的组id
     */
    /**
     * @param $user
     * @return int
     */
    public function getUserGroupId($account){
        $userGroupID = $this->getGroups($account);
