 ...
 * @package     product
 * @version     $Id: model.php 4699 2013-05-02 06:01:01Z wyd621@gmail.com $
...
class productModel extends model
{
    ...
    public function select($products, $productID, $currentModule, $currentMethod, $extra = '')
    {
         ...
         */
        $products = $this->dao->select('id, status, name')->from(TABLE_PRODUCT)->where('id')->in(array_keys($products))->orderBy('convert(`name` using gbk)')->fetchAll();
        /* coship end */
