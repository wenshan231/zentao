...
<div id='featurebar'>
  ...
  <div class='f-right'>
    ...
    <span class="link-button">
      <?php echo html::a($this->createLink('bug', 'import', "productID=$productID&moduleID=$moduleID"), '&nbsp;', '', 'class=bugImport');?>
      <?php echo html::a($this->createLink('bug', 'import', "productID=$productID&moduleID=$moduleID"), $lang->bug->import, '', 'class=import');?>
    </span>
    <?php
