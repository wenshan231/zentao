...
$(document).ready(function()
{
    ...
    /**
     * coship start
     * 2013-12-18 add by fujia
     */
    $(".import").colorbox({width:700, height:350, iframe:true, transition:'none'});
    $(".bugImport").colorbox({width:700, height:350, iframe:true, transition:'none'});
    /* coship end */
});
