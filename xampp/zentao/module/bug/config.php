...
/**
 * coship start
 * 2014-02-19 add by shukaiming
 */
$config->bug->search['fields']['browserDiy']        = $lang->bug->browserDiy;
/* coship end */
/**
 * coship start
 * 2014-02-14 add by shukaiming
 */
$config->bug->search['fields']['recurrenceRate']= $lang->bug->recurrenceRate;
/* coship end */
/**
 * coship start
 * 2014-02-28 add by shukaiming
 */
$config->bug->search['fields']['lastedBuild']= $lang->bug->lastestBuildNote;
/* coship end */
 ...
 * 2014-02-14 add by shukaiming
 */
$config->bug->search['params']['recurrenceRate']= array('operator' => '=',       'control' => 'select', 'values' => $lang->bug->recurrenceRate);
/* coship end */
 ...
 */
$config->bug->fileName      = 'bugListTpl';
$config->bug->fileExtension = 'xls';
$config->bug->filePath      = '../' . $config->bug->fileName . '.' . $config->bug->fileExtension;

$config->bug->import->requiredFields  = 'openedBuild,project,title,severity,pri,type,steps,status,openedBy,openedDate,assignedTo';
$config->bug->create->requiredFields  = 'title,openedBuild,project,pri';
/* coship end */
...
/**
 * coship start
 * 2014-02-14 update by shukaiming
 */
$config->bug->list->allFields = 'id, module, project, story, task, 
    title, keywords, severity, pri, type, os, browser,recurrenceRate, hardware,
...
$config->bug->list->exportFields = 'id, product, module, project, story, task, 
    title, keywords, severity, pri, type, os, browser,recurrenceRate, 
