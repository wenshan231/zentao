 ...
 * @package     bug
 * @version     $Id: model.php 4739 2013-05-04 00:52:40Z chencongzhi520@gmail.com $
...
class bugModel extends model
{
     ...
     */
    public function getProjectLinkedBugs($projectID, $orderBy = 'status_desc', $pager = null, $build = 0)
    {
    	$bugs = $this->dao->select('*')->from(TABLE_BUG)
    	->where('project')->eq((int)$projectID)
    	->beginIF($build != 0)->andWhere('openedBuild')->eq($build)->fi()
