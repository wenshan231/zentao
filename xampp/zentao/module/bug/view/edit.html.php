        ...
        <table class='table-1 a-left'>
          ...
          <tr>
            ...
            <?php 
			   ...
			   */
            if($boolResult){
            	echo html::select('openedBuild[]', $openedBuilds=array('trunk'=>'Trunk'), $bug->openedBuild, 'size=4 multiple=multiple class=select-3');
            }else{ 
				echo html::select('openedBuild[]', $openedBuilds, $bug->openedBuild, 'size=4 multiple=multiple class=select-3');}
			   /* coship end */
			?>
			</span></td>
          </tr>
          ...
          <tr>
            ...
            <!-- coship start 2013-10-21 update by fujia -->
            <?php
            $resolutionList = $lang->bug->resolutionList;
            unset($resolutionList['tostory']);
            ?>
            <td><?php echo html::select('resolution', $resolutionList, $bug->resolution, 'class=select-3 onchange=setDuplicate(this.value)');?></td>
            <!-- coship end -->
