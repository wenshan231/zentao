 ...
 * @package     story
 * @version     $Id: zh-cn.php 4684 2013-04-27 05:49:28Z chencongzhi520@gmail.com $
 ...
 */
$lang->story->priList[3]  = '中';
$lang->story->priList[1]  = '最高';
$lang->story->priList[2]  = '高';
$lang->story->priList[4]  = '低';
/* coship end */
...
/**
 * coship start 
 * 2014-02-08 add&update by shukaiming
 */
$lang->story->specTemplate          = "建议参考的模板：作为一名<<i class='red'>某种类型的用户</i>>，我希望<<i class='red'>达成某些目的</i>>，这样可以提高<<i class='red'>某方面的开发效率</i>>，还可以增加<<i class='red'>某方面的开发价值</i>>。";
/* coship end */
