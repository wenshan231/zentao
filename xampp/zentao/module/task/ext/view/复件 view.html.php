...
<?php endif;?>
  ...
  if(!$task->deleted)
  {
      ...
      if(!(($task->status == 'wait'   or $task->status == 'pause') and common::printLink('task', 'start',  "taskID=$task->id", $lang->task->buttonStart))) echo $lang->task->buttonStart . ' ';
      if(!(($task->status == 'wait'   or $task->status == 'doing') and common::printLink('task', 'pause',   "taskID=$task->id", $lang->task->buttonPause)))   echo $lang->task->buttonPause . ' ';
      if(!(($task->status == 'wait'   or $task->status == 'doing' or $task->status == 'pause')  and common::printLink('task', 'finish', "taskID=$task->id", $lang->task->buttonDone))) echo $lang->task->buttonDone . ' ';
      ...
      if(!(($task->status == 'wait'   or $task->status == 'doing' or $task->status == 'pause')  and common::printLink('task', 'cancel', "taskID=$task->id", $lang->task->buttonCancel))) echo $lang->task->buttonCancel . ' ';
