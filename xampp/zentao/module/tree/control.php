 ...
 * @package     tree
 * @version     $Id: control.php 4687 2013-04-28 01:47:02Z chencongzhi520@gmail.com $
...
class tree extends control
{
    ...
    public function browse($rootID, $viewType, $currentModuleID = 0)
    {
         ...
         */
        elseif($viewType == 'notice')
        {
            $this->loadModel('notice')->setMenu();
            $this->lang->tree->menu      = $this->lang->notice->menu;
            $this->lang->set('menugroup.tree', 'notice');

            $title      = $this->lang->tree->manageNotice;
            $position[] = $this->lang->tree->manageNotice;

            $root = new stdclass();
            $root->name = $this->lang->tree->manageNotice;
            $root->id   = 0;
            $this->view->root = $root;
        }
        /* coship end */
