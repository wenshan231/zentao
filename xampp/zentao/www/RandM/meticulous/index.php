	...
	<?php	
	 ...
	 <tr>
      ...
      <?php       
       if("$logon_decode" == "shaoying" || "$logon_decode" == "zhangchen" || "$logon_decode" == "weishujuan" || "$logon_decode" == "caofubing" || "$logon_decode" == "heping" || "$logon_decode" == "qiaoting" || "$logon_decode" == "xiaoqin" || "$logon_decode" == "tongfang")
       {
       	echo "<a href='./export_week.php'><input type='button' value='统计周数据' style='width:8%; height:4%; margin-left:93%;'></input></a>";
       	echo "<a href='./export_month.php'><input type='button' value='统计月数据' style='width:8%; height:4%; margin-left:93%;'></input></a>";
       }
      ?>  
