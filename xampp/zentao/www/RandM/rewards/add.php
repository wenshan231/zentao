...
<form action="insert.php" method='post' onsubmit="return check();">
  <table>
  <tr>
     <td class='rowhead'><?php echo "表扬人";?></td>
      <td>
	<select size="1" name="presenter" style="width:180px">
	  <?php   	 
    ...
    <tr>
      <td class='rowhead'><?php echo "表扬对象";?></td>
      <td>
	<select size="1" name="rewarder" style="width:180px">
	  <?php 	 
		$strSql = "select * from zt_user where deleted = '0' order by account";  
		$db_selected_zentao = mysql_select_db($zentao_database, $connection_zentao); 
		$users = mysql_query($strSql,$connection_zentao) or die("查询失败！错误是".mysql_error()); 
    ...
    <tr>
      <td class='rowhead'><?php echo "方式";?></td>
      <td><input name="way" id="way" style="width:180px"></td>
    </tr>  
    ...
    <tr>
      <td class='rowhead'><?php echo "闪光点";?></td>      
